...
@Component({
  ...
  styleUrls: ["./loaded.component.css"]
})
export class LoadedComponent {
  ...
  constructor() {
    this.chartOptions = {
      ...
      chart: {
        ...
        type: "bar",
        events: {
          dataPointSelection: (e: any, chart: any, opts: { selectedDataPoints: (string | any[])[]; }) => {
  ...
  public updateQuarterChart(sourceChart: { w: { globals: { selectedDataPoints: any[]; }; config: { series: any[]; }; }; }, destChartIDToUpdate: string) {
    var series = [];
    var seriesIndex = 0;
    var colors = [];
